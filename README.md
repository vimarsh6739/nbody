...
3. `export ENABLE_CILK=1`
4. Build via cmake as above. Ensure that the cmake output has correctly identified and linked Cilk.
5. The nbody executable can be run via `CILK_NWORKERS=1 ./src/cpu_nbody`
